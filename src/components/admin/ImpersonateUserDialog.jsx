...
const TEST_USERS = [
  ...
  { id: "test_print_manager", email: "test_print_manager@example.com", full_name: "印刷部長", department_code: "printing", app_role: "部長", role: "manager", isAdmin: false, isOwner: false },
  { id: "test_binding_manager", email: "test_binding_manager@example.com", full_name: "製本部長", department_code: "production", app_role: "部長", role: "manager", isAdmin: false, isOwner: false },
